  ...
  Widget _topContent(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          Text("A big accident happend lastnight in Egypt"),
          Text(
              "A big accident happend lastnight in EgyptA big accident happend lastnight in Egypt"),
        ],
      ),
    );
  }
              ...
              child: Column(
                ...
                children: <Widget>[
                  Padding(
                    ...
                    child: Text("A big accident happend lastnight in Egypt"),
                  ),
                  Padding(
                    padding:
